...
export default {
    ...
    changelog: {
        title: "バージョン履歴",
        subtitle: "Pixel Compass の進化を追跡。すべての機能、改善、修正の詳細は以下の通りです。",
        ...
        plus_promo: {
            title: "開発をサポート",
            subtitle: "ウィジェットやカスタマイズをアンロックして、新機能の開発にご協力ください。",
            cta: "Pixel Compass+ を入手"
        },
        beta_program: {
            title: "ベータ版に参加",
            subtitle: "公開前に新機能をテストしてください。",
            cta: "ベータプログラムに参加",
            badge: "早期アクセス"
        },
        wear_os_promo: {
            ...
            subtitle_coming: "2026 年第 1 四半期に登場予定。",
            cta: "ウォッチで表示",
            badge: "コンパニオン"
        }
    },
