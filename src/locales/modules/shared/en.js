...
export default {
    ...
    beta_page: {
        page_title: "Beta",
        badge: "Early Access",
        hero_title: "Help shape the future of {appName}",
        hero_subtitle: "Get early access to unreleased features, test new experimental tools, and help us improve the experience for everyone.",
        cta_join: "Join on Google Play",
        updates_title: "Latest Lab Updates",
        view_all_updates: "View full changelog",
        benefits_title: "Why participate?",
        benefit_1_title: "Test New Features",
        benefit_1_desc: "Try out experimental tools before they roll out to everyone.",
        benefit_2_title: "Shape the App",
        benefit_2_desc: "Your feedback directly influences our roadmap.",
        benefit_3_title: "Easy to Leave",
        benefit_3_desc: "Opt-out anytime directly from the Play Store.",
        disclaimer: "Beta versions may be unstable. Features can change, break, or be removed without notice. We strongly recommend backing up your data regularly."
    },
    changelog: {
