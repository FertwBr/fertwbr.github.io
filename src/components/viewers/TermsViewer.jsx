...
export default function TermsViewer({ markdownContent, appConfig, strings }) {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', width: '100%' }}>
                    ...
                    <div>
                        ...
                        {data.lastUpdated && (
                            <div className="last-updated-badge">
                                ...
                                <span>{t.last_updated} {data.lastUpdated}</span>
                            </div>
                        )}
                    </div>
            ...
            {/* Main Content Layout */}
            <div className="terms-layout" style={{ display: 'flex', gap: '60px', alignItems: 'flex-start' }}>
                ...
                <div className="desktop-toc-wrapper" style={{
                    ...
                    <div className="glass-card" style={{
                        ...
                        <h4 style={{ margin: '0 0 8px 0', fontSize: '1rem' }}>{t.contact_title}</h4>
                        <p style={{
                            fontSize: '0.85rem',
