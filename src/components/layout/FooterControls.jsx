...
const MenuItem = ({active, onClick, children, icon}) => {
    ...
    return (
        <button
            ...
            style={{
                background: active ? 'var(--md-sys-color-secondary-container)' : (isHovered ? 'rgba(255,255,255,0.05)' : 'transparent'),
    ...
    return (
        <div style={{position: 'relative'}}>
            <button
                ...
                onMouseLeave={() => setIsHovered(false)}
                style={{
                    background: isOpen || isHovered ? 'var(--md-sys-color-surface-container-highest)' : 'transparent',
    ...
    return (
        <div ref={controlsRef}
            ...
            <div style={{display: 'flex', gap: '12px', flexWrap: 'wrap'}}>
                ...
                >
                    <MenuItem active={isThemeAuto} icon="auto_awesome" onClick={() => {
                        resetTheme();
                        setActiveMenu(null);
                    }}>
                        Auto
                ...
                >
                    <MenuItem active={isLangAuto} icon="auto_awesome" onClick={() => {
                        changeLanguage('auto');
                        setActiveMenu(null);
                    }}>
                        Auto
