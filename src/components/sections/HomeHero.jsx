...
/**
 * Hero section for individual Application pages.
 * Displays app icon, title, download link and Plus CTA.
 *
 * @param {Object} props - Component props.
 * @param {Object} props.appConfig - Application configuration.
 * @param {Object} props.strings - Localization strings for hero content.
 * @param {Function} props.onNavigate - Navigation handler.
 * @returns {JSX.Element} The Home Hero section.
 */
        ...
        <section style={{
            ...
            <div style={{
                ...
                <span className="material-symbols-outlined"
                      style={{color: 'var(--md-sys-color-primary)'}}>expand_more</span>
            </div>
        </section>
    );
}