...
const BackToTop = ({ strings, seedColor, scrollRef }) => {
  ...
  useEffect(() => {
    ...
    const toggleVisibility = () => setVisible(el.scrollTop > 300);
    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          style={{
            position: 'absolute', bottom: '30px', right: '30px', zIndex: 99,
  ...
  return (
    <div style={{ height: 'calc(100vh - 180px)', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ marginBottom: '30px', paddingBottom: '20px', borderBottom: '1px solid var(--md-sys-color-outline-variant)', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '8px', color: 'var(--md-sys-color-on-surface-variant)', fontSize: '0.9rem', textTransform: 'uppercase', letterSpacing: '1px' }}>
      ...
      <div style={{ display: 'flex', gap: '40px', flex: 1, overflow: 'hidden' }}>
        ...
        {/* COLUNA ESQUERDA (WRAPPER RELATIVE) */}
        <div style={{ flex: 1, position: 'relative', display: 'flex', flexDirection: 'column', minWidth: 0 }}>
            ...
            >
                ...
                {visibleCount < filteredVersions.length && (
                    <div style={{ textAlign: 'center', marginTop: '40px', paddingBottom: '60px', paddingLeft: '40px' }}>
                    <button 
            ...
            {/* BOTAO FLUTUANTE (FORA DO SCROLL, DENTRO DO WRAPPER) */}
            <BackToTop strings={strings.changelog} seedColor={seedColor} scrollRef={contentRef} />
        </div>
