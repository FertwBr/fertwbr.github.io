...
const SoundWaveVisual = ({ seedColor }) => (
  <div style={{ padding: '40px 24px', display: 'flex', flexDirection: 'column', height: '100%', justifyContent: 'center' }}>
    <div style={{ marginBottom: '40px', textAlign: 'center' }}>
      <div style={{ fontSize: '14px', opacity: 0.6, textTransform: 'uppercase', letterSpacing: '2px' }}>Current Level</div>
    ...
    <div style={{ marginTop: '40px', padding: '16px', background: 'var(--md-sys-color-primary-container)', borderRadius: '16px', color: 'var(--md-sys-color-on-primary-container)', textAlign: 'center', fontWeight: 600 }}>
      Recording Session...
    </div>
  </div>
);
...
const CompassVisual = ({ seedColor }) => (
  <div style={{ height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
    <div style={{
      ...
      >
        <div style={{ position: 'absolute', top: 0, width: '100%', height: '50%', background: 'var(--md-sys-color-error)', borderRadius: '10px 10px 0 0' }}></div>
        <div style={{ position: 'absolute', bottom: 0, width: '100%', height: '50%', background: 'var(--md-sys-color-on-surface)', borderRadius: '0 0 10px 10px' }}></div>
      </motion.div>
    </div>

    <div style={{ marginTop: '40px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', width: '100%' }}>
      <div style={{ padding: '16px', background: 'var(--md-sys-color-surface-container)', borderRadius: '16px', textAlign: 'center' }}>
